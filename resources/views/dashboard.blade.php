                        ...
                        <tbody>
                            @foreach ($saksiJenis2 as $index => $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('saksi.edit-perdata', ['no_perkara' => $item['no_perkara'], 'tgl_kehadiran' => $item['tgl_kehadiran']]) }}"
